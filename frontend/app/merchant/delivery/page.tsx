          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-border bg-muted/30">
                <th className="px-8 py-5 text-[10px] font-black text-muted-foreground uppercase tracking-widest">Order Details</th>
                <th className="px-8 py-5 text-[10px] font-black text-muted-foreground uppercase tracking-widest">Client Path</th>
                <th className="px-8 py-5 text-[10px] font-black text-muted-foreground uppercase tracking-widest">Package Alpha</th>
                <th className="px-8 py-5 text-[10px] font-black text-muted-foreground uppercase tracking-widest">Fulfillment</th>
                 ...
                 <tr key={i} className="hover:bg-primary/5 transition-colors group">
                   <td className="px-8 py-6">
                      <div className="flex flex-col gap-1">
                         <span className="text-xs font-black text-foreground tabular-nums">{order.id}</span>
                   ...
                   <td className="px-8 py-6">
                      <div className="flex items-center gap-3">
                         ...
                         <div className="flex flex-col">
                            <span className="text-xs font-black text-foreground">{order.customer}</span>
                            <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-tighter">{order.type}</span>
                         </div>
                      </div>
                   </td>
                   <td className="px-8 py-6">
                      <div className="flex flex-col gap-1">
                         <span className="text-xs font-bold text-foreground/80">{order.items} Units</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
         ...
         <Card className="p-8 bg-card border-border flex flex-col justify-center">
            <div className="flex items-center gap-6 mb-6">
               ...
               <div>
                  <h4 className="text-lg font-black text-foreground uppercase tracking-tight">Critical Warnings</h4>
                  <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">System generated alerts</p>
               </div>
            </div>
            <div className="space-y-3">
               <div className="p-3 rounded-xl bg-muted border border-border flex items-center gap-3">
                  <div className="h-2 w-2 rounded-full bg-orange-500 animate-pulse" />
                  <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-tight">3 Orders exceeding SLA fulfillment window</span>
               </div>
               <div className="p-3 rounded-xl bg-muted border border-border flex items-center gap-3">
                  <div className="h-2 w-2 rounded-full bg-red-500" />
                  <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-tight">1 Cancelled order requires inventory audit</span>
               </div>
            </div>
         </Card>
      </div>
