...
const HeroSection: React.FC = () => {
  return (
    <section className="relative w-full h-[120vh] bg-sf-background flex items-center justify-center p-6 md:p-12 overflow-hidden">
      {/* Background Shapes */}
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-16 relative z-10">
        ...
        <div className="flex flex-col justify-center items-start">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-sf-text mb-8 leading-[0.9]">
              REDEFINING <br /> 
              <span className="text-sf-primary">INDIAN <br /> COMMERCE.</span>
            </h1>
            <p className="text-sf-text-muted text-lg max-w-md mb-12 leading-relaxed">
              Experience a premium, curated collection of local artisanship. We bring the soul of Bharat to your doorstep with modern elegance.
            </p>
            ...
            <div className="flex flex-wrap gap-6 items-center">
              <motion.button 
                 ...
                 whileTap={{ scale: 0.95 }}
                 className="group h-16 px-10 bg-sf-primary text-white rounded-2xl flex items-center gap-3 shadow-2xl shadow-sf-primary/25 sf-gradient border border-white/20 transition-all font-black text-sm tracking-widest uppercase overflow-hidden"
              >
                DISCOVER MORE
                <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </motion.button>
              
              <button className="h-16 px-8 rounded-2xl border border-sf-outline/20 text-sf-text font-black text-sm tracking-widest uppercase hover:bg-sf-surface hover:border-sf-primary transition-all flex items-center gap-3">
                VIEW COLLECTIONS
              </button>
            </div>
          </motion.div>

          <div className="mt-20 flex gap-12 border-t border-sf-outline/10 pt-10 w-full opacity-60">
            <div>
        ...
        <div className="relative h-full flex items-center justify-center pt-24 md:pt-0">
          <motion.div 
            ...
            className="relative w-[120%] h-[80%] md:w-full md:h-[90%]"
          >
            {/* Main Product Frame */}
            <div className="absolute inset-0 bg-sf-surface rounded-3xl shadow-[0_50px_100px_rgba(0,0,0,0.1)] overflow-hidden p-4 group">
               <img 
                 src="https://images.unsplash.com/photo-1549298916-b41d501d3772?auto=format&fit=crop&q=80&w=1412" 
            ...
            <motion.div 
              ...
              className="absolute -top-10 -right-10 bg-white p-6 rounded-2xl shadow-2xl border border-sf-outline/10 z-20 flex flex-col gap-2 max-w-[200px]"
            >
            ...
            <motion.div 
              ...
              className="absolute -bottom-12 -left-12 glass p-8 rounded-3xl shadow-2xl z-20 flex items-center gap-6 max-w-sm"
            >
